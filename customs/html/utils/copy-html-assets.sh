...
find ./ -path *${DESTNATION_DIR} -prune -o -iname *.webp -type f -exec rsync -r -R {} ${INDEX_DIR}/${IMAGES_DIR} \;
find ./ -path *${DESTNATION_DIR} -prune -o -iname *.ico -type f -exec rsync -r -R {} ${INDEX_DIR}/${IMAGES_DIR} \;
