...
def create_asciidoc_file(item_properties, id_to_pattern_name):
    file_name = f"guide/modules/contents/pages/patterns/{item_properties['No.']}.adoc"
    ...
    with open(file_name, 'w', encoding='utf-8') as file:
        ...
        # インクルードを作成
        file.write(f"include::../../../../../guide/modules/contents/partials/defines/define-all-include.adoc[]\n\n")
